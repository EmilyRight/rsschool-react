        ...
        : l != null &&
          (Ho(l) &&
            (l = hc(
              l,
              t +
                (!l.key || (i && i.key === l.key) ? '' : ('' + l.key).replace(Ii, '$&/') + '/') +
                e,
            )),
          n.push(l)),
      1
...
var ue = { current: null },
  wr = { transition: null },
  gc = { ReactCurrentDispatcher: ue, ReactCurrentBatchConfig: wr, ReactCurrentOwner: Bo };
function bu() {
...
function es(e, n, t) {
  ...
  return { $$typeof: Sc, type: e, key: o, ref: i, props: l, _owner: _c.current };
}
el.Fragment = kc;
el.jsx = es;
el.jsxs = es;
 ...
 */ (function (e) {
  ...
  function r(_) {
    ...
    if (z !== P) {
      _[0] = z;
      e: for (var Q = 0, G = _.length, bt = G >>> 1; Q < bt; ) {
        var vn = 2 * (Q + 1) - 1,
          wl = _[vn],
          yn = vn + 1,
          er = _[yn];
        if (0 > l(wl, z))
          yn < G && 0 > l(er, wl)
            ? ((_[Q] = er), (_[yn] = z), (Q = yn))
            : ((_[Q] = wl), (_[vn] = z), (Q = vn));
        else if (yn < G && 0 > l(er, z)) (_[Q] = er), (_[yn] = z), (Q = yn);
        else break e;
      }
    }
    return P;
  ...
  function E(_, P) {
    ...
    var z = p;
    try {
      for (d(P), m = t(s); m !== null && (!(m.expirationTime > P) || (_ && !Ne())); ) {
        var Q = m.callback;
        if (typeof Q == 'function') {
          (m.callback = null), (p = m.priorityLevel);
          var G = Q(m.expirationTime <= P);
          (P = e.unstable_now()),
    ...
    (e.unstable_scheduleCallback = function (_, P, z) {
      ...
      return (
        ...
        z > Q
          ? ((_.sortIndex = z),
            n(c, _),
            t(s) === null && _ === t(c) && (S ? (f(N), (N = -1)) : (S = !0), gl(v, z - Q)))
          : ((_.sortIndex = G), n(s, _), w || g || ((w = !0), yl(E))),
        _
      );
    }),
...
var Qe = !(
  ...
  $i = {};
function zc(e) {
  return Yl.call($i, e) ? !0 : Yl.call(Ui, e) ? !1 : Pc.test(e) ? ($i[e] = !0) : ((Ui[e] = !0), !1);
}
function Lc(e, n, t, r) {
...
function Uc(e, n, t, r, l, o, i, u, s) {
  (_t = !1), (Rr = null), Dc.apply(Ic, arguments);
}
...
function Zc(e, n) {
  for (
    ...
    var i = 31 - Re(o),
      u = 1 << i,
      s = l[i];
    s === -1 ? (!(u & t) || u & r) && (l[i] = Gc(u, n)) : s <= n && (e.expiredLanes |= u),
      (o &= ~u);
  }
}
function ao(e) {
...
function pt(e, n) {
  e.blockedOn === n &&
    ((e.blockedOn = null),
    co || ((co = !0), ye.unstable_scheduleCallback(ye.unstable_NormalPriority, ef)));
}
function Dt(e) {
  function n(l) {
    return pt(l, e);
...
function ei(e, n, t, r) {
  if (Fr) {
    var l = fo(e, n, t, r);
    if (l === null) Fl(e, n, r, Dr, t), Xi(e, r);
    else if (bc(l, e, n, t, r)) r.stopPropagation();
    else if ((Xi(e, r), n & 4 && -1 < qc.indexOf(e))) {
      for (; l !== null; ) {
        var o = Jt(l);
        if ((o !== null && Ls(o), (o = fo(e, n, t, r)), o === null && Fl(e, n, r, Dr, t), o === l))
          break;
        l = o;
      }
...
var Pf = Qe && 'TextEvent' in window && !xt,
  Ds = Qe && (!li || (xt && 8 < xt && 11 >= xt)),
  eu = ' ',
  nu = !1;
function Is(e, n) {
  switch (e) {
      ...
      if (p !== void 0) {
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              v !== null &&
              ((d = v), f !== null && ((v = jt(a, f)), v != null && S.push(At(a, v, d)))),
            I)
          )
            break;
          a = a.return;
    ...
    if (!(n & 7)) {
      e: {
        if (
          ...
          p && t !== oo && (w = t.relatedTarget || t.fromElement) && (Sn(w) || w[We]))
        )
          break e;
        if (
          (g || p) &&
          ...
          if (
            ...
            (e === 'pointerout' || e === 'pointerover') &&
              ((S = bi), (v = 'onPointerLeave'), (f = 'onPointerEnter'), (a = 'pointer')),
            (I = g == null ? p : $n(g)),
            (d = w == null ? p : $n(w)),
          ...
          g !== null && cu(m, p, g, S, !1), w !== null && I !== null && cu(m, I, w, S, !0);
        }
      }
      e: {
        if (
      ...
      switch (((x = c ? $n(c) : window), e)) {
        case 'focusin':
          (tu(x) || x.contentEditable === 'true') && ((In = x), (po = c), (Nt = null));
          break;
        case 'focusout':
          Nt = po = In = null;
          break;
      ...
      N &&
        (Ds &&
          ...
          (Dn || N !== 'onCompositionStart'
            ? N === 'onCompositionEnd' && Dn && (C = Fs())
            : ((en = h), (ni = 'value' in en ? en.value : en.textContent), (Dn = !0))),
        (x = Ir(c, N)),
        0 < x.length &&
  ...
  if (U) {
    ...
    if (n) {
      ...
      if (!vu(e, n)) {
        ...
        n = on(t.nextSibling);
        var r = ve;
        n && vu(e, n) ? na(r, t) : ((e.flags = (e.flags & -4097) | 2), (U = !1), (ve = e));
      }
    } else {
      if (ko(e)) throw Error(y(418));
...
function ra(e) {
  ...
  function w(f, a, d, v) {
    ...
    if (C === null) {
      for (; N < d.length; N++)
        (C = m(f, d[N], v)),
          C !== null && ((a = o(C, a, N)), x === null ? (E = C) : (x.sibling = C), (x = C));
      return U && gn(f, N), E;
    }
  ...
  function S(f, a, d, v) {
    ...
    if (T.done) return t(f, C), U && gn(f, N), E;
    if (C === null) {
      for (; !T.done; N++, T = d.next())
        (T = m(f, T.value, v)),
          T !== null && ((a = o(T, a, N)), x === null ? (E = T) : (x.sibling = T), (x = T));
      return U && gn(f, N), E;
    }
      ...
      switch (d.$$typeof) {
        case tr:
          e: {
            for (var E = d.key, x = a; x !== null; ) {
              if (x.key === E) {
                if (((E = d.type), E === Fn)) {
                  ...
                  x.elementType === E ||
                  (typeof E == 'object' && E !== null && E.$$typeof === Ze && gu(E) === x.type)
                ) {
                  t(f, x.sibling),
                    (a = l(x, d.props)),
                    (a.ref = ht(f, x, d)),
            ...
            d.type === Fn
              ? ((a = xn(d.props.children, f.mode, v, d.key)), (a.return = f), (f = a))
              : ((v = Lr(d.type, d.key, d.props, null, f.mode, v)),
                (v.ref = ht(f, a, d)),
                (v.return = f),
                (f = v));
...
function aa(e, n) {
  ...
  if (
    ...
    if (((t.flags |= 2048), Kt(9, fa.bind(null, t, r, l, n), void 0, null), J === null))
      throw Error(y(349));
    Pn & 30 || ca(t, n, l);
  }
  return l;
...
function Ea(e, n, t) {
  return Pn & 21
    ? (je(t, n) || ((t = Ps()), (A.lanes |= t), (zn |= t), (e.baseState = !0)), n)
...
function nd(e, n, t) {
  ...
  if (xa(e)) Ca(n, l);
    ...
    if (e.lanes === 0 && (o === null || o.lanes === 0) && ((o = n.lastRenderedReducer), o !== null))
      try {
        ...
        if (((l.hasEagerState = !0), (l.eagerState = u), je(u, i))) {
          var s = n.interleaved;
          s === null ? ((l.next = l), di(n)) : ((l.next = s.next), (s.next = l)),
            (n.interleaved = l);
          return;
        }
      } catch {
    ...
    (t = oa(e, n, l, r)), t !== null && ((l = ie()), Oe(t, e, r, l), Na(t, n, r));
  }
}
function xa(e) {
  var n = e.alternate;
...
function Co(e, n, t, r) {
  ...
  typeof o == 'object' && o !== null
    ? (l.context = xe(o))
    : ((o = de(n) ? Cn : le.current), (l.context = bn(e, o))),
...
function La(e, n, t) {
  ...
  return (
    o !== null &&
      ...
      (t.callback = function () {
        No(e, n), typeof r != 'function' && (sn === null ? (sn = new Set([this])) : sn.add(this));
        var i = n.stack;
...
function Tu(e, n, t, r, l) {
  ...
  if ((Zn(n, l), n.stateNode === null)) Nr(e, n), Pa(n, t, r), Co(n, t, r, l), (r = !0);
  else if (e === null) {
    var i = n.stateNode,
      u = n.memoizedProps;
    i.props = u;
          ...
          for (var i in o)
            if (o.hasOwnProperty(i)) {
              ...
              i === 'children'
                ? typeof u == 'string'
                  ? r.textContent !== u &&
                    (o.suppressHydrationWarning !== !0 && fr(r.textContent, u, e),
                    (l = ['children', u]))
                  : typeof u == 'number' &&
                    r.textContent !== '' + u &&
                    (o.suppressHydrationWarning !== !0 && fr(r.textContent, u, e),
      ...
      return n.flags & 128
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            r &&
            ((n.child.flags |= 8192),
            n.mode & 1 && (e === null || $.current & 1 ? X === 0 && (X = 3) : zi())),
          n.updateQueue !== null && (n.flags |= 4),
          te(n),
          null);
    case 4:
      return tt(), Ro(e, n), e === null && $t(n.stateNode.containerInfo), te(n), null;
    case 10:
...
function $a(e) {
  ...
  n !== null && ((e.alternate = null), $a(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null && (delete n[De], delete n[Vt], delete n[wo], delete n[Xf], delete n[Gf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Ba(e, n) {
  ...
  switch (e.tag) {
    ...
    case 1:
      ...
      break;
    case 5:
      if ((Pe(n, e), Me(e), r & 512 && t !== null && Qn(t, t.return), e.flags & 32)) {
        var l = e.stateNode;
        try {
          Ot(l, '');
        } catch (S) {
    ...
    case 13:
      Pe(n, e),
        ...
        l.flags & 8192 &&
          ...
          !o || (l.alternate !== null && l.alternate.memoizedState !== null) || (Ci = W())),
        r & 4 && Fu(e);
      break;
    case 22:
      if (
...
function Qa(e, n) {
  ...
  if (r & 30 || r & e.expiredLanes || n) n = qr(e, r);
    ...
    while (!0);
    ci(), (Gr.current = o), (R = l), K !== null ? (n = 0) : ((J = null), (b = 0), (n = X));
  }
  if (n !== 0) {
    ...
    if (n === 6) be(e, r);
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), n)) {
        ...
        case 2:
          ...
          break;
        case 3:
          if ((be(e, r), (r & 130023424) === r && ((n = Ci + 500 - W()), 10 < n))) {
            if (Mr(e, 0) !== 0) break;
...
function be(e, n) {
  for (
    n &= ~xi, n &= ~fl, e.suspendedLanes |= n, e.pingedLanes &= ~n, e = e.expirationTimes;
    0 < n;
    ...
    try {
      ...
      e: {
        ...
        if (
          ...
          var g = Nu(i);
          if (g !== null) {
            (g.flags &= -257), Pu(g, i, u, o, n), g.mode & 1 && Cu(o, c, n), (n = g), (s = c);
            var w = n.updateQueue;
            if (w === null) {
              var S = new Set();
          ...
          var I = Nu(i);
          if (I !== null) {
            !(I.flags & 65536) && (I.flags |= 256), Pu(I, i, u, o, n), si(rt(s, u));
            break e;
          }
        }
...
function Ya(e) {
  ...
  (e.memoizedProps = e.pendingProps), n === null ? Xa(e) : (K = n), (_i.current = null);
}
function Xa(e) {
  var n = e;
  do {
...
function wd(e, n, t) {
  ...
  r !== null && r.delete(n),
    ...
    J === e &&
      (b & t) === t &&
      (X === 4 || (X === 3 && (b & 130023424) === b && 500 > W() - Ci) ? _n(e, 0) : (xi |= t)),
    pe(e, n);
}
function Ga(e, n) {
  ...
  switch (((n.lanes = 0), n.tag)) {
    ...
    case 3:
      e: {
        ...
        (r = n.pendingProps), (o = n.memoizedState), (l = o.element), ia(e, n), Wr(n, r, null, t);
  ...
  switch (e.tag) {
    case 3:
      ...
      if (n.current.memoizedState.isDehydrated) {
        ...
        t !== 0 && (qo(n, t | 1), pe(n, W()), !(R & 6) && ((lt = W() + 500), hn()));
      }
      break;
    case 13:
      Ln(function () {
...
gs = Ni;
ws = Ln;
var zd = { usingClientEntryPoint: !1, Events: [Jt, $n, il, vs, ys, Ni] },
  yt = {
...
class Rd extends Tn.Component {
  constructor(n) {
    super(n),
      ...
      (this.handleSubmit = t => {
        t.preventDefault();
        const { query: r } = this.state,
          { onQuerySubmit: l } = this.props;
        l(r);
      }),
      (this.state = { query: localStorage.getItem('person') || '' });
  }
  render() {
    ...
    return j.jsx(j.Fragment, {
      children: j.jsxs('form', {
        ...
        children: [
          ...
          j.jsx('button', { className: 'input-block__button', type: 'submit', children: 'Search' }),
        ],
      }),
    });
  }
}
class Od extends nl.Component {
  constructor(n) {
    super(n);
  }
  render() {
    const { id: n, name: t, species: r, gender: l, image: o } = this.props;
    return j.jsxs('div', {
      className: 'list__item item',
      id: `${n}`,
      children: [
        j.jsx('div', { className: 'item__image', children: j.jsx('img', { src: o, alt: '' }) }),
        j.jsx('div', { className: 'item__name', children: t }),
        j.jsx('div', { className: 'item__gender', children: l }),
        j.jsx('div', { className: 'item__species', children: r }),
      ],
    });
  }
}
class jd extends Tn.Component {
  render() {
    const { cards: n } = this.props;
    return j.jsx('div', {
      className: 'list-block list',
      children:
        n == null
          ? void 0
          : n.map(({ id: t, name: r, image: l, species: o, gender: i }) =>
              j.jsx(Od, { id: t, name: r, image: l, species: o, gender: i }, t),
            ),
    });
  }
}
class Md extends Tn.Component {
  render() {
    return j.jsx('h1', { children: 'Loading...' });
  }
}
const Fd = 'https://rickandmortyapi.com/api/character/',
  Dd = async (e = '') => {
    const n = await fetch(`${Fd}/${e}`, { method: 'GET' });
    if (!n.ok) throw new Error('Failed to fetch');
    return n.json();
  },
  Id = '?page=1';
class Ud extends Tn.Component {
  constructor(n) {
    super(n),
      (this.handleFetch = async (t, r) => {
        this.setState({ isLoading: !0, isNotFound: !1 });
        try {
          const l = await Dd(t);
          if (t) {
            const o = l.results;
            this.setState({ cardsList: o, isLoading: !1 }), r && localStorage.setItem('person', r);
          }
        } catch {
          this.setState({ isNotFound: !0, isLoading: !1 });
        }
      }),
      (this.handleSubmit = t => {
        const r = t == null ? void 0 : t.trim().replace(/\s/, '').toLowerCase();
        r === '' && this.handleFetch(Id), this.handleFetch(`?name=${r}`, r);
      }),
      (this.throwErrorFunction = () => {
        this.setState({ hasError: !0, isLoading: !1 });
      }),
      (this.state = {
        cardsList: null,
  ...
  render() {
    const { isLoading: n, hasError: t, isNotFound: r } = this.state;
    if (t) throw new Error('Test error');
    return j.jsxs('main', {
      className: 'page__main main',
      children: [
        j.jsx('button', {
          type: 'button',
          className: 'main__error-btn',
          onClick: this.throwErrorFunction,
          children: 'Throw Error',
        }),
        j.jsx('div', {
          className: 'main__input-block',
          children: j.jsx(Rd, { onQuerySubmit: this.handleSubmit }),
        }),
        j.jsx('div', {
          ...
          children:
            n && !r
              ? j.jsx(Md, {})
              : r && !n
                ? j.jsx('div', { className: 'empty', children: " There's nothing here :(" })
                : j.jsx(jd, { cards: this.state.cardsList }),
        }),
      ],
    });
  }
}
class $d extends Tn.Component {
  constructor(n) {
  ...
  componentDidCatch(n, t) {
    console.error('Error Boundary caught an error', n, t);
  }
  render() {
    return this.state.hasError
      ? j.jsx('h1', { children: 'Something went wrong...' })
      : this.props.children;
  }
}
class Ad extends Tn.Component {
  render() {
    return j.jsx('div', { className: 'page', children: j.jsx($d, { children: j.jsx(Ud, {}) }) });
  }
}
Kl.createRoot(document.getElementById('root')).render(
  j.jsx(Tn.StrictMode, { children: j.jsx(Ad, {}) }),
);
