...
function Uc(e, n, t, r, l, o, i, u, s) {
  (_t = !1), (Rr = null), Fc.apply(Ic, arguments);
}
...
function ei(e, n, t, r) {
  if (Dr) {
    ...
    if (l === null) Dl(e, n, r, Fr, t), Xi(e, r);
      ...
      for (; l !== null; ) {
        var o = Jt(l);
        if ((o !== null && Ls(o), (o = fo(e, n, t, r)), o === null && Dl(e, n, r, Fr, t), o === l))
          break;
        l = o;
      }
      ...
      N &&
        (Fs &&
          ...
          (Fn || N !== 'onCompositionStart'
            ? N === 'onCompositionEnd' && Fn && (C = Ds())
            : ((en = h), (ni = 'value' in en ? en.value : en.textContent), (Fn = !0))),
        (x = Ir(c, N)),
        0 < x.length &&
...
function $a(e) {
  ...
  n !== null && ((e.alternate = null), $a(n)),
    ...
    e.tag === 5 &&
      ((n = e.stateNode),
      n !== null && (delete n[Fe], delete n[Vt], delete n[wo], delete n[Xf], delete n[Gf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
const Dd = 'https://rickandmortyapi.com/api/character/',
  Fd = async (e = '') => {
    const n = await fetch(`${Dd}/${e}`, { method: 'GET' });
...
class Ud extends Tn.Component {
  constructor(n) {
    super(n),
      (this.handleFetch = async t => {
        this.setState({ isLoading: !0 });
        try {
          const r = await Fd(t);
          let l;
          t ? (l = [r]) : (l = r.results), this.setState({ cardsList: l, isLoading: !1 });
        } catch (r) {
          this.setState({ hasError: !0, isLoading: !1 }), console.log(r);
        }
      }),
      (this.handleSubmit = t => {
        const r = t == null ? void 0 : t.trim().replace(/\s/, '');
        r === '' && this.handleFetch(Id), this.handleFetch(r);
      }),
  ...
  render() {
    const { isLoading: n, hasError: t } = this.state;
    ...
    return j.jsxs('main', {
      ...
      children: [
        ...
        j.jsx('div', {
          ...
          children: n ? j.jsx(Md, {}) : j.jsx(jd, { cards: this.state.cardsList }),
        }),
      ],
    });
  }
